...
for i,n in enumerate(sc("\u5168\u7403\u8d22\u7ecf\u8981\u95fb \u6700\u65b0 \u91cd\u8981 2026",5),1):
    t=n.get("title","").strip()
    u=n.get("url","")
    if t: lines.append(f"{i}. [{t}]({u})")
lines.append("")

lines.append("\u4e8c\u3001A\u80a1\u590d\u76d8\u4e0e\u5f00\u76d8\u5fc5\u8bfb")
for q in ["A\u80a1 \u590d\u76d8 \u5206\u6790 \u6700\u65b0", "\u5f00\u76d8\u524d\u5fc5\u8bfb A\u80a1 \u4eca\u65e5"]:
    for n in sc(q,3):
        t=n.get("title","").strip()
        u=n.get("url","")
...
for i,n in enumerate(sc("\u5168\u7403\u91cd\u5927\u65b0\u95fb \u56fd\u9645 \u6700\u65b0 2026",5),1):
    t=n.get("title","").strip()
    u=n.get("url","")
    if t: lines.append(f"{i}. [{t}]({u})")
lines.append("")
